...
export default function Form() {
  ...
  const handleOnChange = (event) => {
    ...
    navigator.clipboard.writeText("gandu");
  ...
  return(
    ...
    <div className="mb-3">
      ...
      <button type="button" className="btn btn-primary my-3 mx-4" onClick={clrtxt}>Clear Text</button><br></br>
      <h3>Summary</h3>
